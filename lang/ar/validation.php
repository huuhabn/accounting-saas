...
return [
    ...
    'ascii' => 'يجب أن يحتوي حقل :attribute فقط على أحرف أبجدية رقمية ورموز أحادية البايت.',
    ...
    'contains' => 'يفتقد حقل :attribute القيمة المطلوبة.',
    ...
    'json' => 'يجب أن يكون حقل السمة: سلسلة JSON صالحة.',
    'list' => 'يجب أن يكون حقل السمة عبارة عن قائمة.',
    ...
    'min' => [
        ...
        'string' => 'يجب أن يحتوي حقل :attribute على الأقل على أحرف:min.',
    ],
    ...
    'missing_with_all' => 'يجب أن يكون الحقل:attribute مفقودًا عند وجود القيم:.',
    ...
    'starts_with' => 'يجب أن يبدأ حقل السمة بواحد مما يلي: القيم.',
