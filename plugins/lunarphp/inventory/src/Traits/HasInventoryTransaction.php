...
trait HasInventoryTransaction
{
    ...
    {
        $reason = __('hs.inventory::reasons.transactions.' . $key, ['id' => $this->getKey(), 'date' => date('Y-m-d H:i:s')]);
     ...
     * @param int|float|string $cost
     *
     * @return $this|bool|HasInventoryTransaction
     * @throws InvalidTransactionStateException
     *
     */
