...
namespace HanaSales\FilamentAdvanced\Forms\Fields;
...
class Combobox extends Select
{
    ...
    protected string $view = 'filament-advanced::combobox';

    protected function setUp(): void
    {
        parent::setUp();

        $this->optionsLabel = __('filament-advanced::lang.labels.options');
        $this->selectedLabel = __('filament-advanced::lang.labels.selected');

        $this->registerListeners([
            'filament-advanced::comboBoxUpdateState' => [fn (Component $component, string $statePath, array $values) => $statePath === $component->getStatePath() ? $this->updateState($values) : null],
        ]);
    }
