...
namespace HanaSales\FilamentAdvanced\Concerns;
...
class BgImage
{
    ...
    public function getImage(): Image
    {
        ...
        return new Image(
            'url("' . asset('img/filament-advanced/backgrounds/' . $image['url']) . '")',
            __('Photo by :author on :service', Arr::only($image, ['author', 'service']))
        );
    }
    public function getTrianglesImage(): Image
    {
        return new Image(
            'url("' . asset('img/filament-advanced/backgrounds/svg/' . sprintf('%02d', random_int(1, 25)) . '.svg') . '")'
        );
    }
